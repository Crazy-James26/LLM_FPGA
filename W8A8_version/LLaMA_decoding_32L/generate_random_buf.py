...
def generate_random_ln(prj_path, data_num):
    for buf_id in range (13, 16):
    ...
    for buf_id in range (17, 29):
        ...
        with open(file_path, "w") as file:
            if data_num > 1:
                ...
                file.writelines("static const float buf" + str(buf_id) + " = " + str(datas[0])[0:8] + ";")
            file.close()
