...
int main(int argc, char** argv) {
    ...
    // CL_MEM_USE_HOST_PTR
    size_t size_bytes_in0 = sizeof(ap_uint<512>) * 32*768;
    std::vector<ap_uint<512>, aligned_allocator<ap_uint<512> > > source_in0(32*768);
    
    size_t size_bytes_wk = sizeof(ap_uint<128>) * 48*768;
    std::vector<ap_uint<128>, aligned_allocator<ap_uint<128> > > source_wk(48*768);
    size_t size_bytes_wv = sizeof(ap_uint<128>) * 48*768;
    std::vector<ap_uint<128>, aligned_allocator<ap_uint<128> > > source_wv(48*768);
    size_t size_bytes_wq = sizeof(ap_uint<128>) * 48*768;
    std::vector<ap_uint<128>, aligned_allocator<ap_uint<128> > > source_wq(48*768);
    size_t size_bytes_w_ds0 = sizeof(ap_uint<128>) * 48*768;
    std::vector<ap_uint<128>, aligned_allocator<ap_uint<128> > > source_w_ds0(48*768);
    size_t size_bytes_w_ds1 = sizeof(ap_uint<128>) * 192*768;
    std::vector<ap_uint<128>, aligned_allocator<ap_uint<128> > > source_w_ds1(192*768);
    size_t size_bytes_w_ds2 = sizeof(ap_uint<128>) * 48*3072;
    std::vector<ap_uint<128>, aligned_allocator<ap_uint<128> > > source_w_ds2(48*3072);

    size_t size_bytes_out0 = sizeof(ap_uint<512>) * 32*768;
    std::vector<ap_uint<512>, aligned_allocator<ap_uint<512> > > source_out0(32*768);
